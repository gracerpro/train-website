const releaseList = [
  ...
  },
  {
    ...
    <ul>
      ...
      <li>Добавлен импорт тренировок из сервиса <b>Strava</b>.</li>
      <li>Добавлен импорт тренировок из сервиса <b>Adidas running</b>.</li>
      <li>Добавлен экспорт тренировок в архив за год, месяц, диапазон дат.</li>
